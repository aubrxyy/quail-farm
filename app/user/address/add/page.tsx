...
export default function AddAlamat() {
  ...
  const outsideBounds: [[number, number], [number, number]][] = [
    [[-90, -180], [90, 106.3]], // West
    [[-90, 107.1], [90, 180]],  // East
    [[-6.9, 106.3], [-90, 107.1]], // South
    [[-5.8, 106.3], [90, 107.1]]   // North
  ];
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-[#EDC043] to-[#ED9C40] px-8 py-6">
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-white">Tambah Alamat Baru</h1>
                  <p className="text-white text-opacity-90">Masukkan informasi alamat pengiriman Anda</p>
                </div>
              </div>
            </div>
                ...
                >
                  <FeatureGroup>
                    {outsideBounds.map((bounds, i) => (
                      <Rectangle key={i} bounds={bounds} pathOptions={{ fillColor: "gray", fillOpacity: 0.4, weight: 0 }} />
                    ))}
                  </FeatureGroup>
                  <TileLayer
